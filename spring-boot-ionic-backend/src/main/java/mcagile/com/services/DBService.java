...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "waltson.silva@hotmail.com", "888888888",
				TipoCliente.PESSOAJURIDICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Silva", "waltson.dasilva@gmail.com", "888888888",
				TipoCliente.PESSOAJURIDICA, pe.encode("123"));
